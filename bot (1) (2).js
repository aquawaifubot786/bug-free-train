...
// Optional database - works WITHOUT it too (GitHub Actions compatible)
let pool = null;
if (process.env.DATABASE_URL) {
    pool = new Pool({ connectionString: process.env.DATABASE_URL });
} else {
    console.log('⚠️  No DATABASE_URL set - using file-based storage only');
}
...
async function initializeSpawnTracker() {
    try {
        if (pool) {
            ...
            console.log('⚠️  Database not available - skipping spawn tracker initialization');
        }
    } catch (error) {
...
bot.on('callback_query', async (query) => {
    ...
    try {
        if (data === 'menu_credits') {
            ...
            const helpText = `<b>𝗕𝗔𝗦𝗜𝗖 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 (1/2)</b>\n\n<b>/START</b> - <i>Start the bot</i>\n\n<b>/GRAB</b> - <i>Grab a random waifu from spawn</i>\n\n<b>/FAV</b> - <i>Add a character to your favorites</i>\n\n<b>/DWAIFU</b> - <i>Claim your daily waifu</i>\n\n<b>/PAY</b> - <i>Give 💸 cash to other users</i>\n\n<b>/BAL</b> - <i>See your current balance</i>`;
            await bot.editMessageText(helpText, {
                chat_id: chatId,
                message_id: messageId,
                parse_mode: 'HTML',
            ...
            const helpText = `<b>𝗕𝗔𝗦𝗜𝗖 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 (2/2)</b>\n\n<b>/HAREM</b> - <i>View your waifu collection</i>\n\n<b>/PROFILE</b> - <i>Check your profile</i>\n\n<b>/HELP</b> - <i>View all available commands</i>\n\n<b>/TOP</b> - <i>See leaderboards</i>\n\n<i>Use /start to begin!</i>`;
            await bot.editMessageText(helpText, {
                chat_id: chatId,
                message_id: messageId,
                parse_mode: 'HTML',
            ...
            const helpText = `<b>𝗜𝗡𝗧𝗘𝗥𝗔𝗖𝗧𝗜𝗩𝗘 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 (1/2)</b>\n\n<b>/BAZAAR</b> - <i>View daily limited/auctions/marketplace</i>\n\n<b>/CMODE</b> - <i>Change your harem mode</i>\n\n<b>/MARRY</b> - <i>Marry a random character</i>\n\n<b>/PROPOSE <id></b> - <i>Propose to a specific character (costs 25k 💸)</i>\n\n<b>/EXPLORE</b> - <i>Get some 💸 cash</i>`;
            await bot.editMessageText(helpText, {
                chat_id: chatId,
                message_id: messageId,
                parse_mode: 'HTML',
            ...
            const keyboard = {
                inline_keyboard: [
                    [{ text: '⬅️ PREVIOUS', callback_data: 'help_interactive' }],
                    [{ text: '« BACK', callback_data: 'menu_help' }]
                ]
            };
            const helpText = `<b>𝗜𝗡𝗧𝗘𝗥𝗔𝗖𝗧𝗜𝗩𝗘 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 (2/2)</b>\n\n<b>/DART <amount></b> - <i>Bet your 💸 in a dart game</i>\n\n<b>/TRADE</b> - <i>Trade waifus with other users</i>\n\n<b>/SELL <id></b> - <i>Sell a waifu</i>\n\n<b>/DELETE <id></b> - <i>Remove a waifu from database (dev only)</i>\n\n<i>💡 Use commands in groups for maximum fun!</i>`;
            await bot.editMessageText(helpText, {
                chat_id: chatId,
                message_id: messageId,
                parse_mode: 'HTML',
